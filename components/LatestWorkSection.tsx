...
const LatestWorkSection: React.FC = () => {
  return (
    <section id="latest-works" className="latest-work max-w-screen-xl mx-auto px-4 relative pb-8 sm:pb-16">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
        ...
        <Link href="#" className="order-1 sm:order-2 flex w-full relative justify-center sm:justify-start">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
        ...
        <Link href="#" className="flex w-full relative justify-center sm:justify-start">
